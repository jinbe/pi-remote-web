							...
							<div class="flex gap-2 pt-1">
								...
								{#if job.session_id}
									<a href="/session/{job.session_id}" class="btn btn-xs btn-ghost gap-1">
										View Session <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" /></svg>
									</a>
								{/if}
							</div>
						</div>
