...
export function isAncestorOf(tree: SessionTree, ancestorId: string, descendantId: string): boolean {
...
export function findLeafFrom(tree: SessionTree, startId: string): string {
	let cur = startId;
	while (true) {
...
export function getBranchPoints(tree: SessionTree): Map<string, BranchPoint> {
